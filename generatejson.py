...
def main(input_file, output_filename, image_ctx):
...
if __name__ == '__main__':
    ...
    with open('resources/image-context.json', 'r') as image_context_file:
        image_context_json_obj = json.load(image_context_file, 'UTF-8')
    try:
        with open(args.input_file, 'r') as input_file:
            main(input_file, args.output_file, image_context_json_obj)
